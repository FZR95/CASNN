...
class FCN_ONNX(nn.Module):
    def __init__(self, n_channels, n_classes, out_channels=128, backbone=True):
        super(FCN_ONNX, self).__init__()
...
class RESNET(nn.Module):
    def __init__(self, n_channels, n_classes, out_channels=128, backbone=True):
        ...
        self.conv_block_res = nn.Sequential(nn.Conv1d(32, 64, kernel_size=8, stride=1, bias=False, padding=4),
                                         nn.BatchNorm1d(64),
                                         nn.ReLU(),
                                         nn.MaxPool1d(kernel_size=2, stride=2, padding=1))
        ...
        self.conv_block2 = nn.Sequential(nn.Conv1d(32, 64, kernel_size=8, stride=1, bias=False, padding=4),
                                         nn.BatchNorm1d(64),
                                         nn.ReLU())
        self.conv_block3 = nn.Sequential(nn.Conv1d(64, 64, kernel_size=8, stride=1, bias=False, padding='same'),
                                         nn.BatchNorm1d(64),
                                         nn.ReLU())
        self.conv_block4 = nn.Sequential(nn.Conv1d(64, 64, kernel_size=8, stride=1, bias=False, padding='same'),
                                         nn.BatchNorm1d(64),
                                         nn.ReLU(),
                                         nn.MaxPool1d(kernel_size=2, stride=2, padding=1))
        

        self.conv_block5 = nn.Sequential(nn.Conv1d(64, out_channels, kernel_size=8, stride=1, bias=False, padding=4),
                                         nn.BatchNorm1d(out_channels),
                                         nn.ReLU(),
                                         nn.MaxPool1d(kernel_size=2, stride=2, padding=1))
        self.dropout = nn.Dropout(0.3)
